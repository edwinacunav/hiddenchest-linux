...
void tableBindingInit()
{
  ...
  rb_define_singleton_method(klass, "_load", RMF(TableLoad), -1);
  rb_define_method(klass, "initialize", RMF(tableInitialize), -1);
  rb_define_method(klass, "initialize_copy", RMF(TableInitializeCopy), -1);
  rb_define_method(klass, "resize", RMF(tableResize), -1);
  rb_define_method(klass, "xsize", RMF(tableXSize), 0);
  rb_define_method(klass, "ysize", RMF(tableYSize), 0);
  rb_define_method(klass, "zsize", RMF(tableZSize), 0);
  rb_define_method(klass, "[]", RMF(tableGetAt), -1);
  rb_define_method(klass, "[]=", RMF(tableSetAt), -1);
}
