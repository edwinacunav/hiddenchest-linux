...
** Modified (C) 2019 Kyonides Arkanthes <kyonides@gmail.com>
**
...
public:
  ...
  void stretchBlt(const IntRect &destRect,
                  ...
                  int opacity = 255);
  void gradient_blend(int x, int y, SDL_Surface *s);
  void fillRect(int x, int y, int width, int height, const Vec4 &color);
  void fillRect(const IntRect &rect, const Vec4 &color);
  void gradientFillRect(int x, int y, int width, int height, const Vec4 &color1,
                        const Vec4 &color2, int mode = 0);
  void gradientFillRect(const IntRect &rect, const Vec4 &color1,
                        const Vec4 &color2, int mode = 0);
...
private:
  SDL_Surface* render_str(bool solid, const char *str, SDL_Color c);
  void h_flip_pixels(SDL_Surface *s, IntRect rect);
