...
initALCFunctions(ALCdevice *alcDev)
{
  ...
  Dbg() << "ALC_SOFT_pause_device present";
...
void EventThread::process(RGSSThreadData &rtData)
{
  ...
  while (true)
  {
    ...
    case SDL_QUIT :
      terminate = true;
      Dbg() << "EventThread termination requested";
      break;
    case SDL_KEYDOWN :
    ...
    default :
      ...
      case REQUEST_SETCURSORVISIBLE :
        ...
        break;
      case UPDATE_FPS :
        if (rtData.config.printFPS) Dbg() << "FPS:" << event.user.code;
...
int EventThread::eventFilter(void *data, SDL_Event *event)
{
  ...
  case SDL_APP_WILLENTERBACKGROUND :
          Dbg() << "SDL_APP_WILLENTERBACKGROUND";
  ...
  case SDL_APP_DIDENTERBACKGROUND :
          Dbg() << "SDL_APP_DIDENTERBACKGROUND";
          return 0;

  case SDL_APP_WILLENTERFOREGROUND :
          Dbg() << "SDL_APP_WILLENTERFOREGROUND";
          return 0;

  case SDL_APP_DIDENTERFOREGROUND :
          Dbg() << "SDL_APP_DIDENTERFOREGROUND";
  ...
  case SDL_APP_TERMINATING :
          Dbg() << "SDL_APP_TERMINATING";
          return 0;

  case SDL_APP_LOWMEMORY :
          Dbg() << "SDL_APP_LOWMEMORY";
          return 0;
