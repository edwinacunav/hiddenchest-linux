...
** Extended by Kyonides Arkanthes <kyonides@gmail.com>
**
...
MRB_METHOD(fontInitialize)
{
  ...
  f->initDynAttribs();// Wrap property objects
...
DEF_PROP_B(Font, Underline)
DEF_PROP_B(Font, Strikethrough)
...
DEF_KLASS_PROP(Font, mrb_bool, DefaultUnderline, "b", bool)
DEF_KLASS_PROP(Font, mrb_bool, DefaultStrikethrough, "b", bool)
...
fontBindingInit(mrb_state *mrb)
{
  ...
  INIT_KLASS_PROP_BIND(Font, DefaultUnderline,  "default_underline");
  INIT_KLASS_PROP_BIND(Font, DefaultStrikethrough,  "default_strikethrough");
  INIT_KLASS_PROP_BIND(Font, DefaultStrikethrough,  "default_strikethru");
  ...
  INIT_PROP_BIND(Font, Underline,  "underline");
  INIT_PROP_BIND(Font, Strikethrough,  "strikethrough");
  INIT_PROP_BIND(Font, Strikethrough,  "strikethru");
